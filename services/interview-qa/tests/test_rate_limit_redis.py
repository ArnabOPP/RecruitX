...
separate processes — the entire point of INTERVIEW_QA_RATE_LIMIT_STORAGE_URI.
...
container; skips cleanly if Docker isn't available. Ported from cv-parser's
...
def redis_uri():
    ...
    port = _free_port()
    container_name = "interview-qa-test-redis-ratelimit"
