...
Content-Length before FastAPI ever parses it. The cap here is larger than
answer-grading's (source code + multiple test cases can legitimately be
bigger than a single answer/rubric payload) but still bounded.
"""
