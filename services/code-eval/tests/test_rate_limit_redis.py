...
separate processes — ported from the other services' identical test; the
underlying `limits` library mechanics are the same regardless of service.
...
def redis_uri():
    ...
    port = _free_port()
    container_name = "code-eval-test-redis-ratelimit"
