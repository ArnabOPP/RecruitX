"""Tests for MaxBodySizeMiddleware — same pattern as every other Recruitix
service. Tested against a minimal standalone app rather than the real
app.main.app to avoid polluting shared module state (and paying the real
vision-model load cost) across test files."""
