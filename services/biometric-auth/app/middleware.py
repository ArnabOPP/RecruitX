...
Content-Length before FastAPI ever parses it. The cap is generous enough
for a handful of JPEG frames per request (enrollment/verify send ~5,
liveness sends ~10) but still firmly bounded.
"""
