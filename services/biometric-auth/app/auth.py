...
Same pattern as the other services. Protects both compute resources (face
detection/embedding inference) and, more importantly here, the enrolled
biometric reference data itself — an unauthenticated /verify endpoint
would let anyone probe whether a given face matches a given candidate_id.
"""
