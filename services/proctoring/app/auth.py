...
Same pattern as the other Recruitix services. Protects both compute
resources (face detection/pose inference) and, more importantly, a
candidate's integrity score/event history — an unauthenticated summary
endpoint would let anyone read another candidate's proctoring record.
"""
