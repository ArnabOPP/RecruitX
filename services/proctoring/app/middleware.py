...
Same pattern as the other Recruitix services: rejects an oversized body
via Content-Length before FastAPI ever parses it. The cap is sized for a
single JPEG snapshot frame per request.
"""
